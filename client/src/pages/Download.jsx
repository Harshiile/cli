...
export default function DownloadPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Downloads - JOU CLI</title>
                <meta name="description" content="Download the JOU CLI tool for Linux, macOS, or Windows and start managing your YouTube uploads directly from the terminal" />
