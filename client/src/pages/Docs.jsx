...
export default function DocsPage() {
    ...
    return (
        <>
            <Helmet>
                <title>Documentation - JOU CLI</title>
                <meta name="description" content="Explore the complete JOU CLI documentation. Learn how to use commands, manage video uploads, schedule publishing, and collaborate with editors" />
